...
8.  **Prompt Quality**:
    *   **Image Prompts**: Must be EXTREMELY DETAILED. Include lighting (volumetric, cinematic), texture (8k, unreal engine 5 render), and exact character positioning.
...
export const getUpdateSystemPrompt = (settings: ScenarioSettings): string => {
  ...
  return `
You are an expert Prompt Engineer for 3D Animation.
...
2. **Image Prompt Style**: Pixar style 3D render, 8k, highly detailed, volumetric lighting.
...
[
  {
    ...
    "image_prompt": "String (Rewritten Detailed English Image Prompt)",
    "video_prompts": [
